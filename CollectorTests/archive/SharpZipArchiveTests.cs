...
namespace CollectorTests.archive
{
    public class SharpZipArchiveTests
    {
        ...
        public void TestRoundtripArchive()
        {
            ...
            Collector.archive.File file = new Collector.archive.File(entryName, testFileData, new DateTime());
        ...
        private static MemoryStream CreateZipArchive(IEnumerable<Collector.archive.File> testData, string password, string level)
        {
